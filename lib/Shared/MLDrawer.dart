...
class _MultiLevelDrawerState extends State<MultiLevelDrawer> {
  ...
  getPositions(duration) {
    ...
    double start = dy -15;
    double end = renderBox.size.height + start + 50;
    double step = ((end) - (start)) / (drawerItems.length) + 20;
    itemSize = step;
    positions = [];
...
//        color: Color.fromRGBO(133, 38, 255, 1),
            child: InkWell(
...
//              border: Border(
//                  bottom: BorderSide(
//                      color: divisionColor ?? Colors.white, width: 1.0))
//          ),
