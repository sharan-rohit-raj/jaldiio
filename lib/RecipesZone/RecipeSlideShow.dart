...
class RecipeSlideShow extends StatefulWidget {
  String famCode;
  RecipeSlideShow({Key key, @required this.famCode}) : super(key: key);

  @override
  _RecipeSlideShowState createState() => _RecipeSlideShowState();
}

class _RecipeSlideShowState extends State<RecipeSlideShow>
...
//                  print(slideList[current-1]);
  ...
  Stream queryDb({String tag = 'food'}) {
