...
class _EditProfileState extends State<EditProfile> {
  ...
  Future<Null> _selectDate(BuildContext context) async {
    ...
    if (picked != null && picked != selectedDate)
      setState(() {
        selectedDate = picked;
        _customerDateController.text = selectedDate.day.toString() +
            "/" +
                                        ...
                                        showPicker().then((value) async {
                                          ...
                                          if (_image != null) {
                                            ...
                                            showSnackBar(
                                                ...
                                                _scaffoldKey);
                                            StorageUploadTask profileUpload =
                                                strgimgrfrnc.putFile(_image);
                                            StorageTaskSnapshot
                                                storageTaskSnapShot =
                                                await profileUpload.onComplete;
                                            imgURL = await storageTaskSnapShot
                                                .ref
                                                .getDownloadURL();
                                            print(
                                                "The image url is :" + imgURL);
                                            await _auth
                                                .uploadProfileImage(imgURL)
                            ...
                            Container(
                              ...
                              child: TextFormField(
                                ...
                                style: GoogleFonts.openSans(
                                    ...
                                    color: Colors.deepPurpleAccent),
                                validator: (val) =>
                                    val.isEmpty ? 'Enter a Status' : null,
                                onChanged: (val) {
//                              setState(() => password = val);
                                },
                              ),
